...
const SLEEP_GRACE_MS = 100000; // 100s grace after last packet before showing Sleep
...
(function(){
  ...
  if (typeof window.computeStatus === 'function' && !window.__overrodeComputeStatus){
    ...
    window.computeStatus = function(normId){
      ...
      const graceMs   = activeSec ? activeSec*1000 : (typeof SLEEP_GRACE_MS!=='undefined' ? SLEEP_GRACE_MS : 100000);
