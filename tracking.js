...
function trilatLM(beacons, initXY){
  ...
  // Equal weights — device sends real measured distances, no need to favour closer beacons
  ...
  // Multiple start points: centroid, each beacon, midpoints between pairs, provided init
